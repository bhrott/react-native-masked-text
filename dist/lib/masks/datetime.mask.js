...
format:'DD/MM/YYYY HH:mm:ss'};var


DatetimeMask=function(_BaseMask){_inherits(DatetimeMask,_BaseMask);function DatetimeMask(){_classCallCheck(this,DatetimeMask);return _possibleConstructorReturn(this,(DatetimeMask.__proto__||Object.getPrototypeOf(DatetimeMask)).apply(this,arguments));}_createClass(DatetimeMask,[{key:'getValue',value:function getValue(
...
return isValid;
}},{key:'_getMergedSettings',value:function _getMergedSettings(

settings){
return _get(DatetimeMask.prototype.__proto__||Object.getPrototypeOf(DatetimeMask.prototype),'mergeSettings',this).call(this,DATETIME_MASK_SETTINGS,settings);
}}],[{key:'getType',value:function getType(){return'datetime';}}]);return DatetimeMask;}(_base2.default);exports.default=DatetimeMask;