...
OnlyNumbersMask=function(_BaseMask){_inherits(OnlyNumbersMask,_BaseMask);function OnlyNumbersMask(){_classCallCheck(this,OnlyNumbersMask);return _possibleConstructorReturn(this,(OnlyNumbersMask.__proto__||Object.getPrototypeOf(OnlyNumbersMask)).apply(this,arguments));}_createClass(OnlyNumbersMask,[{key:'getValue',value:function getValue(
...
return _get(OnlyNumbersMask.prototype.__proto__||Object.getPrototypeOf(OnlyNumbersMask.prototype),'removeNotNumbers',this).call(this,maskedValue);
}},{key:'validate',value:function validate(

value,settings){
return true;
}}],[{key:'getType',value:function getType(){return'only-numbers';}}]);return OnlyNumbersMask;}(_base2.default);exports.default=OnlyNumbersMask;